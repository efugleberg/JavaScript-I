...
const getid = inventory.find(inventory => inventory.id === 33);
// console.log(getid.car_year);
console.log('Car 33 is a ' + getid.car_year + " " + getid.car_make + " " + getid.car_model);

// ==== Challenge 2 ====
// The dealer needs the information on the last car in their inventory.  What is the make and model of the last car in the inventory?  Log the make and model into the console.
let newArr = inventory.slice();
let lastCar = newArr[newArr.length-1];
